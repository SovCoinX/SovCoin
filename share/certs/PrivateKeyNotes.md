...
unlocked to sign the SOV-Qt.app bundle.
...
allowing somebody to distribute a SOV-Qt.app or sov-qt-setup.exe with a valid
...
that the sov-qt.exe file inside the installer had not been tampered with.

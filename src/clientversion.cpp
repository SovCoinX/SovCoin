 ...
 * for both sovd and sov-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("SOV Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/sov/bips/blob/master/bip-0014.mediawiki) 
 */

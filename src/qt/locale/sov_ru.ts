...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса SOV для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса SOV для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: если Вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ SOV&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сейчас SOV Core закроется для завершения процесса шифрования. Помните, что шифрование вашего кошелька не может полностью защитить ваши даши от кражи с помощью инфицирования вашего компьютера вредоносным ПО.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Дальнейшая безопасная работа SOV Core невозможна, программа будет закрыта.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес SOV</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и sov: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>О &amp;SOV Core</translation>
    </message>
    <message>
        <source>Show information about SOV Core</source>
        <translation>Показать информацию о SOV Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изменить параметры конфигурации SOV Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами SOV, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами SOV</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть sov: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать справку по SOV Core со списком возможных параметров командной строки</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Клиент SOV Core</translation>
    </message>
    <message numerus="yes">
        <source>%n active connection(s) to SOV network</source>
        <translation><numerusform>%n активное соединение с сетью SOV</numerusform><numerusform>%n активных соединения с сетью SOV</numerusform><numerusform>%n активных соединений с сетью SOV</numerusform><numerusform>%n активных соединений с сетью SOV</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать 2 отдельные мастерноды для перемешивания до 1000 SOV</translation>
    </message>
    <message>
        <source>Use 8 separate masternodes to mix funds up to 1000 SOV</source>
        <translation>Использовать 8 отдельных мастернод для перемешивания до 1000 SOV</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Это самый быстрый вариант, анонимизация 1000 SOV будет стоить вам примерно 0.025 SOV</translation>
    </message>
    <message>
        <source>This option is moderately fast and will cost about 0.05 SOV to anonymize 1000 SOV</source>
        <translation>Это относительно быстрый вариант, анонимизация 1000 SOV будет стоить вам примерно 0.05 SOV</translation>
    </message>
    <message>
        <source>0.1 SOV per 1000 SOV you anonymize.</source>
        <translation>0.1 SOV за каждые анонимизированные 1000 SOV.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом SOV.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в SOV Core.</translation>
    </message>
    <message>
        <source>As this is the first time the program is launched, you can choose where SOV Core will store its data.</source>
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где SOV Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>SOV Core скачает и сохранит копию цепочки блоков. Как минимум %1ГБ данных будет храниться в этом каталоге и размер данных будет со временем расти. В этом же каталоге будет сохранён кошелёк.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Последние транзакции пока что могут быть не видны и поэтому ваш баланс может отображаться некорректно. Информация будет корректироваться по мере синхронизации с сетью SOV, подробности о ходе синхронизации представлены ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Сумма постоянно анонимизированных SOV</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически запускать SOV Core после входа в систему.</translation>
    </message>
    <message>
        <source>&amp;Start SOV Core on system login</source>
        <translation>&amp;Запускать SOV Core при входе в систему</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для SOV Core на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети SOV через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска SOV Core.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети SOV через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью SOV после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>0 SOV / 0 раундов</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик sov: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес SOV либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>SOV Core еще не завершил работу...</translation>
    </message>
    <message>
        <source>Amount</source>
        <translation>Сумма</translation>
    ...
    <message>
        ...
        <translation>Введите адрес SOV (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл SOV Core из текущего каталога данных. Для больших лог-файлов эта операция может занять несколько секунд.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добро пожаловать в RPC-консоль SOV Core.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть SOV.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть SOV.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес SOV</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес SOV для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше SOV, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К sov: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть SOV.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>SOV Core выключается...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения своими адресами, чтобы доказать, что Вы можете получать SOV на них. Будьте осторожны, не подписывайте что-то неопределённое, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The SOV address to sign the message with</source>
        <translation>Адрес SOV, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом SOV</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес SOV, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified SOV address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом SOV</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Разработчики SOV Core</translation>
    </message>
    <message>
        <source>The SOV Core developers</source>
        <translation>Разработчики SOV Core</translation>
...
<context>
    ...
    <message>
        ...
        <translation>InstantSend пока что не поддерживает такие большие суммы. На данный момент транзакции ограничены суммами до %1 SOV.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, SOV Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось привязаться к %s на этом компьютере. Возможно, SOV Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: кошелёк требует более новой версии SOV Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверка на непротиворечивость закончилась неудачно. SOV Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать кошелёк: перезапустите SOV Core для завершения операции</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Держать N SOV анонимизированными (по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к SOV (Мастерноды, PrivateSend, InstantSend, Governance) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Пожалуйста, убедитесь что дата и время на Вашем компьютере выставлены правильно! SOV Core не сможет работать корректно, если часы настроены неверно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обнаружить достаточных для выполнения этой транзакции неденоминированных средств, отличающихся от 1000 SOV.</translation>
    </message>
    <message>

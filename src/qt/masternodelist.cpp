...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, const COutPoint& outpoint)
{
    ...
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(fFound ? CSOVAddress(infoMn.pubKeyCollateralAddress.GetID()).ToString() : ""));
...
void MasternodeList::updateNodeList()
{
    ...
    for(auto& mnpair : mapMasternodes)
    {
        ...
        QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(CSOVAddress(mn.pubKeyCollateralAddress.GetID()).ToString()));

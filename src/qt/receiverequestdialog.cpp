...
#include "config/sov-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSOVURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SOVUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSOVURI(info));
}

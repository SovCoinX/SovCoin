...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all SOV related functionality
...
/*
    ...
    allow endless transaction that would bloat SOV and make it unusable. To

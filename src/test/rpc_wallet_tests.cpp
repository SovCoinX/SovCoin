...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CSOVAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CSOVAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CSOVAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CSOVAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CSOVAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSOVAddress(arr[0].get_str()).Get() == demoAddress.Get());

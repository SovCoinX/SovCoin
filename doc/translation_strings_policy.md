...
This document provides guidelines for internationalization of the SOV Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sov_en.ts` remains unchanged.

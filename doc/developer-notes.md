...
SOV Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- SOVMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as SOV Core, where everyone uses
...
pay attention to for reviewers of SOV Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SOV Core uses tinyformat, which is type safe. Leave them out to avoid confusion
